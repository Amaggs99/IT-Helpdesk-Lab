...
Simulate a common Help Desk request where a user is unable to access network resources due to incorrect DNS server configuration. Demonstrate how to identify the issue, investigate connectivity, restore the correct DNS settings, and verify successful name resolution using both graphical tools and PowerShell.
...
Uses PowerShell to verify DNS resolution.
...
\- Testing both IP connectivity and hostname resolution helps quickly isolate DNS-related issues.
